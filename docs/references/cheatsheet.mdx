...
- **CSS property**: Name of the declaration (e.g. color)
...
| <CodeBlock language="css" className="inline-code">@st-import [x as local-x] from './y.st.css';</CodeBlock>      | Local alias for named import ([api](../references/imports.md#alias-javascript-named-exports)) |
