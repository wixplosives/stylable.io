...
| Syntax                                                                                          | Explanations                                                                               |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| <CodeBlock language="css" className="inline-code">:vars { x: red; y: blue; }</CodeBlock>        | Build time variables definition ([api](../references/st-variables.md#use-in-stylesheet))   |
| <CodeBlock language="css" className="inline-code">prop: value(x);</CodeBlock>                   | Insert var value into declaration ([api](../references/st-variables.md#use-in-stylesheet)) |
