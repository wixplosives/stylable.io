      ...
      <main>
          ...
          <div className="container">
            <div className="row">
              <Feature title="CSS Superset" imageUrl="img/component.svg">
                Extending CSS so that it is easier to use in a component ecosystem, but without losing any of the
                declarative, familiar, static and fast aspects of CSS.
              </Feature>
              <Feature title="Style API" imageUrl="img/api.svg">
                Each component exposes a Style API that maps its internal parts and states so you can reuse components
                across teams without sacrificing stylability or scalability.
              </Feature>
              <Feature title="Type Safety" imageUrl="img/stethoscope.svg">
                Provide the ability to see errors at build time or even while working in your IDE. Wave goodbye to
                silent run-time breakage misery!
              </Feature>
              <Feature title="Performant" imageUrl="img/checklist.svg">
                Perform build-time transpilation and require only a minimal runtime. Use custom states and properties
              ...
              <Feature title="Developer Tooling" imageUrl="img/tool.svg">
                Use our language-intelligence IDE extension for a better development experience including completions,
                defintions, hinting, diagnostics and more.
              </Feature>
            </div>
          </div>
        </section>
        <section className={clsx(styles.section, styles.sectionAlt)}>
          <div className="container">
            ...
            <p>
              ...
              CSS. Its simple, declarative syntax that is native in browsers is easily the fastest way to add styles to
              web pages and web apps. But when writing CSS that is scoped to individual components, developers have to
              maintain highly-specific selectors, using elaborate conventions to fake namespacing. Writing and
              maintaining CSS across large teams and large projects can be tricky.
            </p>
            <p>
              We also <span className={styles.heart}>&hearts;</span> TypeScript. TypeScript helps us manage these large
              projects, exposing at build-time what we could once only see at run-time.
            </p>
            <div>
              We want to give CSS a <em>type system</em> &mdash; to do for CSS what TypeScript does for JavaScript.
              <ul>
                {/* <li>
            ...
            So we created <strong>Stylable</strong> &mdash; a CSS preprocessor that enables you to write style rules in
            CSS syntax, with some extensions that we believe adhere to the spirit of CSS.
          </div>
        </section>
        <section className={styles.section}>
          <div className="container">
            ...
            <ul>
              <li>Stylable scopes styles to components so they don’t "leak" and clash with other styles.</li>
              <li>
                Stylable enables custom pseudo-classes and pseudo-elements that abstract the internal state and
                structure of a component. These can then be styled externally. For example, you can style the label
                inside a button, or style the play button of a video player from outside these components.
              </li>
              <li>
                At build time, the preprocessor converts the Stylable CSS into flat, static, valid, vanilla CSS that
                works cross-browser.
              </li>
            </ul>
          </div>
        ...
        <section className={clsx(styles.section, styles.sectionAlt)}>
          <div className="container">
            <h2>Tooling</h2>
            <img className={styles.lspDemo} src="img/stylable-lsp-opt.gif" alt="Stylable Intelligence Demo" />
        ...
        <section className={clsx(styles.section, styles.sectionAlt)}>
          <div className="container">
            <h2>Documentation</h2>
            <Link to="./docs/getting-started/intro">Learn more about Stylable</Link> and get started with step by step
        ...
        <section className={styles.section}>
          <div className="container">
            ...
            <p>
              ...
              showcasing the features and typed style API. Bruce explains it in his React Europe 2018 talk:
            </p>
            <div>
        ...
        <section className={clsx(styles.section, styles.sectionAlt)}>
          <div className="container">
            <div>
              ...
              <p>
                No need! <strong>Stylable</strong> is open-source. Take it, use it, make your development easier and
                your apps faster. Viva CSS, and welcome <strong>Stylable</strong>. We hope you like it.
              </p>
              <p>
              ...
              <blockquote className={styles.quote}>
                <p>
                  New ideas will come along, but they will extend CSS rather than replace it. I believe that the CSS
                  code we write today will be readable by computers 500 years from now.
                </p>
                <small>
                  &mdash; <Link to="https://dev.opera.com/articles/css-twenty-years-hakon/">Håkon Wium Lie</Link>,
                  co-creator of CSS.
                </small>
              </blockquote>
            </div>
